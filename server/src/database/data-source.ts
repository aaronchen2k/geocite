...
import { ExecutionDiagnosisEventEntity, ExecutionDiagnosisRunEntity, ExecutionDiagnosisStepEntity } from '../modules/execution-diagnosis/execution-diagnosis.entity';

export const dataSourceOptions: DataSourceOptions = {
  type: 'sqlite',
  database: process.env.NODE_ENV === 'test' ? ':memory:' : 'data/geocite.sqlite',
  entities: [BrandEntity, BrandEngineEntity, EngineEntity, ModelEntity, RagAgentEntity, ExecutionDiagnosisRunEntity, ExecutionDiagnosisStepEntity, ExecutionDiagnosisEventEntity],
  synchronize: true,
};
