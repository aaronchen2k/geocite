...
export class DiagnosisConfigurationController {
  ...
  @Put() save(@Param('brandId', ParseIntPipe) brandId: number, @Body() dto: SaveDiagnosisQuestionsDto) { return this.service.save(brandId, dto.questions, dto.prompt, dto.sitemapUrlLimit, dto.samplingQuestionCount, dto.questionCategoryRatio, dto.playwrightWebReviewEnabled); }
