...
import { AttributionRecordEntity, ComparisonExperimentEntity, DiagnosisComparisonEntity, DiagnosisFindingEntity, OptimizationActionEntity, OptimizationWorkOrderEntity, PeriodicRetestPlanEntity } from './optimization-verification.entity';

@Module({ imports: [TypeOrmModule.forFeature([BrandEntity, BrandEngineEntity, EngineEntity, ModelEntity, CompetitorEntity, BrandDiagnosisQuestionEntity, ExecutionDiagnosisRunEntity, ExecutionDiagnosisStepEntity, ExecutionDiagnosisEventEntity, ExecutionDiagnosisPageEntity, ExecutionDiagnosisProbeEntity, ExecutionDiagnosisSampleEntity, DiagnosisFindingEntity, OptimizationWorkOrderEntity, OptimizationActionEntity, DiagnosisComparisonEntity, AttributionRecordEntity, PeriodicRetestPlanEntity, ComparisonExperimentEntity])], controllers: [ExecutionDiagnosisController, DiagnosisConfigurationController, DiagnosisInsightsController], providers: [ExecutionDiagnosisService, DiagnosisConfigurationService, DiagnosisInsightsService] })
