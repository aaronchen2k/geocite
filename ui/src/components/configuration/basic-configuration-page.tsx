...
type DiagnosisConfiguration = { questions: Array<{ id: number; text: string; group: string; market: 'cn' | 'global' | 'both'; brandProbe: boolean }>; prompt: string; sitemapUrlLimit: number; samplingQuestionCount: number; questionCategoryRatio: QuestionCategoryRatio };
